...
@router.post('/login')
def login(user_credentials: OAuth2PasswordRequestForm = Depends(OAuth2PasswordRequestForm), 
    ...
    return {'access_token': access_token, "token_type": "bearer", "user_details": user_details} #return a token
