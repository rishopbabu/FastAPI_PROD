...
# Get all posts
@router.get("/get_all_posts", name="Get all posts", response_model=List[schemas.PostVoteResponse]) # here List[schemas.PostResponse] -> to get all posts in a list in get all posts
...
@router.get("/get_post/{id}", name="Get posts by Id", response_model=schemas.PostVoteResponse)
...
# Post a single posts
@router.post("/create_post", name = "Post a posts", status_code = status.HTTP_201_CREATED, response_model = schemas.PostResponse)
...
# Update a post
@router.put("/update_post/{id}", name="Update posts by Id", response_model=schemas.PostResponse)
...
@router.delete("/delete_post/{id}", name="Delete posts by Id", status_code= status.HTTP_200_OK)
